...
async def receive_data(request: Request):
    try:
        ...
        return {"message": f"File created and saved successfully"}
    except Exception as e:
        return {"message": f"Error: {str(e)}"}
    # gửi thành công file từ client lên sever và lưu vào đường dẫn dưới tên file là ngày tháng năm sử dụng thư viện request 
