...
class Communication(Base):
    ...
    id_driver_list = Column(
        Integer,
        ForeignKey("driver_list.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=True,
    )
    id_type_baud_rates = Column(Integer, nullable=True)
    id_type_parity = Column(
        Integer,
        ForeignKey("type_parity.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=True,
    )
    id_type_stopbits = Column(
        Integer,
        ForeignKey("type_stopbits.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=True,
    )
    id_type_timeout = Column(
        Integer,
        ForeignKey("type_timeout.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=True,
    )
    id_type_debug_level = Column(
        Integer,
        ForeignKey("type_debug_level.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=True,
    )
...
class Config_information(Base):
    ...
    id_type = Column(
        Integer,
        ForeignKey("config_type.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
    )
    status = Column(Boolean, nullable=False, default=True)
...
class Point_list(Base):
    ...
    type_byteorder = relationship(
        "Config_information", foreign_keys=[id_type_byteorder]
    )
...
class Device_register_block(Base):
    ...
    id_device_group = Column(
        Integer,
        ForeignKey("device_group.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
    )
    id_device_list = Column(
        Integer,
    ...
    id_register_block = Column(
        Integer,
        ForeignKey("register_block.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
    )
    # --------------------------------------------------
    # addr = Column(Integer, nullable=False)
...
class Sync_data(Base):
    ...
    id_upload_channel = Column(
        Integer,
        ForeignKey("upload_channel.id", ondelete="CASCADE", onupdate="CASCADE"),
        nullable=False,
    )
    id_device = Column(
        Integer,
    ...
    createtime = Column(TIMESTAMP(timezone=True), nullable=True)
    updatetime = Column(TIMESTAMP(timezone=True), nullable=True)
...
def create_table_device(table_name):
    ...
    return DynamicTable.__table__.create(engine)
