...
class Devices(DBSessionManager.Base):
...
class DeviceType(DBSessionManager.Base):
...
class DeviceGroup(DBSessionManager.Base):
...
class DeviceComponent(DBSessionManager.Base):
