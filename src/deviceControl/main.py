...
async def handle_messages_driver(client,serial_number_project, host, port, username, password):
    global MQTT_TOPIC_SUD_MODEGET_INFORMATION ,MQTT_TOPIC_SUD_MODECONTROL_DEVICE
    topic_all = [serial_number_project + MQTT_TOPIC_SUD_MODEGET_INFORMATION, serial_number_project + MQTT_TOPIC_SUD_MODECONTROL_DEVICE ]
